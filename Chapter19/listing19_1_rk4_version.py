...
while (T < 30.0):
    ...
    # it is possible to avoid ading noise to measurement
		if NOISE == 1:
...
plt.plot(ArrayT,ArrayWH,label='W hat', linewidth=0.6)
...
plt.plot(ArrayT,ArraySP33P,label='-sp33', linewidth=0.6)
#plt.plot(t,sp11n,label='sp11n', linewidth=0.6)
plt.xlabel('Time (Sec)')
