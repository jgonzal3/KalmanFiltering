...
#PHI = np.matrix([[math.cos(W*TS), math.sin(W*TS)/W],[-W*math.sin(W*TS), math.cos(W*TS)]])
PHI = np.matrix([[1, TS],[-W*W*TS, 1]])
...
for T in [x*TS for x in range(0,201)]:
	...
	XHOLD=XH
	RES=XS-XH-TS*XDH
	XH=XH+TS*XDH+K[0,0]*RES
	XDH=-W*W*TS*XHOLD+XDH+K[1,0]*RES
