...
for T in [x*TS for x in range(0,201)]:
	...
	XS=X+XNOISE
	XHOLD=XH
	RES=XS-XH*math.cos(WH*TS)-math.sin(WH*TS)*XDH/WH
	XH=math.cos(WH*TS)*XH+XDH*math.sin(WH*TS)/WH+K[0,0]*RES
	XDH=-WH*math.sin(WH*TS)*XHOLD+XDH*math.cos(WH*TS)+K[1,0]*RES
